...
Advanced Software Development — Laboratory Materials
...
1. Use
   Using the Materials for commercial purposes or incorporating them into
   another course, training program, publication, or educational resource.

2. Reproduction
   Copying, reproducing, downloading, or storing all or any substantial
   portion of the Materials.

3. Modification
   Modifying, adapting, translating, reverse engineering, or creating
   derivative works based on the Materials.
...
5. Commercial Use
   ...
   service, training course, consultancy, or revenue-generating activity.

PERMISSION REQUESTS

To request permission or obtain a licence for any of the above uses, please
contact:
...
or in connection with the Materials or the use of the Materials.
